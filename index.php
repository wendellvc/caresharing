...
<html class="no-js" lang="">
    <head>
		...
		<script src="js/ngRepeatReorder.js"></script>
											...
											<div class="js-list list-wrapper" ng-repeat="board in listCardsByBoard" ng-cloak>
												<div class="list js-list-content">
													...
													<div class="list-cards u-fancy-scrollbar u-clearfix js-list-cards js-sortable ui-sortable">
														<div class="list-card js-member-droppable ui-droppable" ng-repeat="card in board.card_data" ng-cloak>
															<div class="list-card-details" ng-hide="editorEnabled">
																...
																<a class="list-card-title js-card-name" href="javascript:;" editable-text="card.cardtext" ><span class="card-short-id hide">{{card.card_id}}</span>{{card.cardtext}}</a>
															</div>
														</div>
													</div>
												</div>
